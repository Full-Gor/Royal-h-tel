...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulation d'envoi selon la méthode choisie
      await new Promise(resolve => setTimeout(resolve, 1500));
      
      if (formData.contactMethod === 'email') {
        flash.showSuccess('Email envoyé !', 'Votre message a été envoyé par email. Nous vous répondrons dans les plus brefs délais.');
      } else if (formData.contactMethod === 'sms') {
        flash.showSuccess('SMS envoyé !', 'Votre message a été envoyé par SMS. Nous vous répondrons rapidement.');
      } else {
        flash.showSuccess('Message enregistré !', 'Nous vous contacterons par téléphone dans les plus brefs délais.');
      }
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      value: 'contact@chateauroyal.com',
