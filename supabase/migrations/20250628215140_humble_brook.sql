...
-- Version corrigée pour toutes les versions de MySQL
...
-- Génération d'IDs uniques pour les catégories
SET @cat1_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @cat2_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @cat3_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @cat4_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));

-- Insertion des catégories par défaut
INSERT INTO room_categories (id, name, description, max_occupancy) VALUES
(@cat1_id, 'Suite Présidentielle', 'Suite d''exception avec services premium', 2),
(@cat2_id, 'Chambre de Luxe', 'Chambre élégante avec équipements haut de gamme', 2),
(@cat3_id, 'Chambre Familiale', 'Spacieuse chambre pour familles', 4),
(@cat4_id, 'Chambre Standard', 'Confort et élégance à prix accessible', 2);

-- Génération d'IDs uniques pour les chambres
SET @room1_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @room2_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @room3_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @room4_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));

-- Insertion des chambres par défaut (avec images en format texte)
...
-- Génération d'IDs pour les réservations
SET @booking1_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @booking2_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
...
(@booking1_id, 'admin-uuid-12345', @room1_id, '2024-01-15', '2024-01-16', 2, 'night', 1200.00, 'completed', 'paid'),
(@booking2_id, 'admin-uuid-12345', @room2_id, '2024-02-01', '2024-02-04', 2, 'threeDays', 1200.00, 'confirmed', 'paid');

-- Génération d'IDs pour les messages
SET @msg1_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
SET @msg2_id = CONCAT(SUBSTRING(MD5(RAND()), 1, 8), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 4), '-', SUBSTRING(MD5(RAND()), 1, 12));
...
(@msg1_id, 'Jean Dupont', 'jean.dupont@email.com', '0123456789', 'Demande de réservation', 'Bonjour, je souhaiterais réserver une suite pour le weekend prochain.', 'email', 'new'),
(@msg2_id, 'Marie Martin', 'marie.martin@email.com', '0987654321', 'Question sur les services', 'Proposez-vous un service de spa ?', 'email', 'read');
